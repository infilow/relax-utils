...
@SuppressWarnings({"ResultOfMethodCallIgnored", "RedundantClassCall", "rawtypes"})
public class ParallelStreamTest extends AbstractParallelStreamTest<Double, DoubleStream, ParallelDoubleStream> {
    ...
    public void boxed() {
        ...
        assertThat(stream, instanceOf(ParallelStream.class));
        assertSame(this.mappedDelegateMock, ParallelStream.class.cast(stream).delegate);
        assertSame(this.workerPool, ParallelStream.class.cast(stream).workerPool);
    }
