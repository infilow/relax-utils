...
import static com.infilos.utils.Futures.*;
...
public class FuturesTest {
    ...
    public void allAsList_empty() {
        ...
        assertThat(Futures.ofList(input), completesTo(emptyList()));
    }
    ...
    public void allAsList_one() {
        ...
        assertThat(Futures.ofList(input), completesTo(singletonList(value)));
    }
    ...
    public void allAsList_multiple() {
        ...
        final List<CompletableFuture<String>> input = values.stream()
            ...
            .collect(toList());
        assertThat(Futures.ofList(input), completesTo(values));
    }
    ...
    public void allAsMap_one() {
        ...
        assertThat(Futures.ofMap(input), completesTo(singletonMap(key, value)));
    }
    ...
    public void allAsMap_multiple() {
        ...
        assertThat(Futures.ofMap(input), completesTo(asMap(keys, values)));
    }
    ...
    public void getException_completedExceptionally() {
        final Exception ex = new Exception("boom");
        final CompletionStage<String> future =Futures.ofFailed(ex);
        assertThat(Futures.getException(future), is(ex));
    }
    ...
    public void getException_returnsNullIfImplementationDoesNotThrow() {
        ...
        assertNull(Futures.getException(future));
    }

    @Test
    public void exceptionallyCompletedFuture_completed() {
        final CompletableFuture<String> future =Futures.ofFailed(new Exception("boom"));
    ...
    public void exceptionallyCompletedFuture_throws() throws Exception {
        final Exception ex = new Exception("boom");
        final CompletableFuture<String> future =Futures.ofFailed(ex);
    ...
    public void joinList_exceptional() throws Exception {
        final RuntimeException ex = new RuntimeException("boom");
        final CompletableFuture<String> a = completedFuture("hello");
        final CompletableFuture<String> b =Futures.ofFailed(ex);

        final CompletableFuture<List<String>> result = Stream.of(a, b).collect(Futures.joinList());
    ...
    public void joinList_containsNull() {
        ...
        exception.expect(NullPointerException.class);
        stream.collect(Futures.joinList());
    }

    @Test
    public void joinMap_empty() throws Exception {
        final Map<String, String> result = Stream.<String>of()
            .collect(Futures.joinMap(identity(), CompletableFuture::completedFuture))
            .get();
    ...
    public void joinMap_one() throws Exception {
        final Map<String, String> result = Stream.of("a")
            .collect(Futures.joinMap(identity(), k -> completedFuture(k + "v")))
            .get();
    ...
    public void joinMap_two() throws Exception {
        final Map<String, String> result = Stream.of("hello", "world")
            .collect(Futures.joinMap(e -> "k " + e, e -> completedFuture("v " + e)))
            .get();
    ...
    public void joinMap_exceptional() throws Exception {
        ...
        final CompletableFuture<Map<String, String>> result = Stream.of("a", "b")
            .collect(Futures.joinMap(identity(), v -> v.equals("a") ? a : b));
    ...
    public void joinMap_containsNull() {
        ...
        exception.expect(NullPointerException.class);
        stream.collect(Futures.joinMap(identity(), v -> v.equals("a") ? a : b));
    }

    @Test
    public void dereference_completed() {
        final CompletionStage<String> future = completedFuture("hello");
        final CompletionStage<String> dereferenced = Futures.dereference(completedFuture(future));
    ...
    public void dereference_exceptional() {
        ...
        final CompletionStage<Object> future =Futures.ofFailed(ex);
        final CompletionStage<Object> dereferenced = Futures.dereference(completedFuture(future));
    ...
    public void dereference_null() {
        final CompletionStage<Object> dereferenced = Futures.dereference(completedFuture(null));
    ...
    public void exceptionallyCompose_complete() {
        final CompletionStage<String> future =Futures.ofFailed(new Exception("boom"));
        final CompletableFuture<String> fallback = completedFuture("hello");

        final CompletionStage<String> composed = Futures.exceptionallyCompose(future, throwable -> fallback);
    ...
    public void exceptionallyCompose_exceptional() {
        ...
        final CompletableFuture<String> fallback =Futures.ofFailed(fallbackException);
    ...
    public void exceptionallyCompose_throws() {
        ...
        final CompletionStage<String> composed = Futures.exceptionallyCompose(future, throwable -> {
            throw ex;
        });
    ...
    public void exceptionallyCompose_returnsNull() {
        ...
        final CompletionStage<String> composed = Futures.exceptionallyCompose(future, throwable -> null);
    ...
    public void handleCompose_failure() {
        ...
        final CompletionStage<String> composed =
            handleCompose(future, (s, t) -> Futures.ofFailed(ex));
    ...
    public void combine2_exceptional() throws Exception {
        final CompletionStage<String> future = combine(
            completedFuture("a"),
            Futures.ofFailed(new IllegalStateException()),
            (a, b) -> a + b);
    ...
    public void combineVararg_exceptional() {
        final CompletionStage<String> first = completedFuture("a");
        final CompletionStage<String> second =Futures.ofFailed(new IllegalStateException());
        final CompletionStage<String> future = combine(combined -> combined.get(first) + combined.get(second), first, second);
    ...
    public void ctor_preventInstantiation() throws Exception {
        ...
        final Constructor<Futures> ctor = Futures.class.getDeclaredConstructor();
