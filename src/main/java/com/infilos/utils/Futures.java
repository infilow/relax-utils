...
import com.infilos.api.Function3;
import com.infilos.api.Function4;
import com.infilos.api.Function5;
import com.infilos.api.Function6;
import com.infilos.utils.future.CombinedFutures;
 ...
 *
 * @see <a href="https://github.com/spotify/completable-futures"/>
 */
public final class Futures {
    ...
    public static <T, S extends CompletionStage<? extends T>> Collector<S, ?, CompletableFuture<List<T>>> joinList() {
        return collectingAndThen(toList(), Futures::ofList);
    }
    ...
    public static <T, K, V> Collector<T, ?, CompletableFuture<Map<K, V>>> joinMap(Function<? super T, ? extends K> keyMapper,
        ...
        Collector<T, ?, Map<K, CompletionStage<? extends V>>> collector = toMap(keyMapper, valueFutureMapper);
        return collectingAndThen(collector, Futures::ofMap);
    }
     ...
     * @since 0.1.0
     */
    public static <R, A, B> CompletionStage<R> combine(CompletionStage<A> a, CompletionStage<B> b,
     ...
     */
    public static <T> CompletableFuture<T> poll(final Supplier<Optional<T>> pollingTask,
    ...
    private static <T> void pollTask(final Supplier<Optional<T>> pollingTask,
