...
public class BackoffStrategyTest {
    ...
    public void verifyBackoffStrategy_noWait() {
        ...
        Duration durationToWait = backoffStrategy.nextDelayToWait(5, Duration.ofSeconds(30));
    ...
    public void verifyBackoffStrategy_fibonacci() {
        ...
        Duration durationToWait = backoffStrategy.nextDelayToWait(4, Duration.ofMillis(delayInMillis));
    ...
    public void verifyBackoffStrategy_fibonacci_noArrayIndexOutOfBounds() {
        FibonacciBackoffStrategy backoffStrategy = new FibonacciBackoffStrategy();
        backoffStrategy.nextDelayToWait(100, Duration.ofSeconds(1));
    }
    ...
    public void verifyBackoffStrategy_fixed() {
        ...
        Duration durationToWait
            = backoffStrategy.nextDelayToWait(5, Duration.ofMillis(millisBetweenTries));
    ...
    public void verifyBackoffStrategy_random() {
        ...
        Duration durationToWait = backoffStrategy.nextDelayToWait(10, Duration.ofMillis(100));
    ...
    public void verifyBackoffStrategy_exponential() {
        ...
        Duration durationToWait = backoffStrategy.nextDelayToWait(5, Duration.ofMillis(100));
    ...
    public void verifyBackoffStrategy_exponentialFirstRetry() {
        ExponentialBackoffStrategy backoffStrategy = new ExponentialBackoffStrategy();
        Duration durationToWait = backoffStrategy.nextDelayToWait(1, Duration.ofMillis(100));
    ...
    public void verifyBackoffStrategy_exponentialRemainsPositive() {
        ExponentialBackoffStrategy backoffStrategy = new ExponentialBackoffStrategy();
        Duration durationToWait = backoffStrategy.nextDelayToWait(10000, Duration.ofMillis(100));
