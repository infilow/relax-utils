...
public class ObjectSizeTest {
    ...
    @Before
    public void setUp() {
        MemoryLayoutSpec memoryLayoutSpec =
            new MemoryLayoutSpec() {
        ...
        A = memoryLayoutSpec.getArrayHeaderSize();
        O = memoryLayoutSpec.getObjectHeaderSize();
        R = memoryLayoutSpec.getReferenceSize();
        S = memoryLayoutSpec.getSuperclassFieldPadding();

        objectSizeCalculator = new ObjectSizeCalculator(memoryLayoutSpec);
    }
    ...
    public void testComplexObject() {
        ComplexObject<Object> l = new ComplexObject<>();
        l.add(new Object());
        l.add(new Object());
        l.add(new Object());
